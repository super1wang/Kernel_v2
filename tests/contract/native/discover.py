...
def main():
    ...
    for name in names:
        ...
        label = 'B5;D3.04' if name.split('.')[-1] in {
            ...
            'host_structured_lifetime', 'host_structured_admission', 'host_async_completion', 'host_async_drain', 'host_async_deadline', 'host_required_record', 'host_required_record_drain', 'host_cached_result_sessions'} else 'D1.05'

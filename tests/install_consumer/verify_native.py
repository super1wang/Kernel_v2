...
def main():
    ...
    if report != {'sdk':'0.1.0-dev.7','stage':'B6Subset','checks':dict.fromkeys(('read','compute','invalid_input','ready_gate','shutdown'),True)}:
    ...
    if a.case == 'metadata':
        ...
        if manifest['sdk_version']!='0.1.0-dev.7' or manifest['stage']!='B6Subset' or manifest['targets']['Runtime']['kind']!='STATIC_LIBRARY':

...
inline void return_move_observation() {
    ...
    Env no_value(false,compute,{},[](registry::ModuleInput& m){m.register_operations=[](registry::Registrar& r){CHECK(r.compute(void_handler,native_definition(),native_options()));};});

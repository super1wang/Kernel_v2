...
int main(int argc,char** argv){
  try{
    CHECK(argc==2);
    const std::map<std::string,void(*)()> cases{{"T07.policy.owned_inputs_budget",budget_contract},{"T07.policy.authentication_source",authentication_source},{"T07.policy.scope_four_way",scope_four_way},{"T20.policy.queued_revoke_drop",queued_revoke_drop}};
